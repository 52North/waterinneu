...
<ul>
  <li>
    <a href="#top">Home</a><br />The landingpage includes
    <ul>
  ...
  <li><a href="e-learning">E-Learning</a><br />Detailed courses about featured products.</li>
  ...
  <li><a href="related-portals">Water Related Resources</a><br />A list of water related resources that might be beneficial for our users/visitors.</li>
  <li><a href="api">API::JSON</a><br />A JSON endpoint to the content of this marketplace.</li>
  <li><a href="contact">Helpdesk</a><br />Request support when using the marketplace.</li>
  <li><a href="sites/default/files/documents/WaterInnEU_Marketplace_User-Guide.pdf">User Guide</a><br />User Guide for the marketplace as pdf document to download and print.</li>
  <li><a href="imprint">Imprint</a><br />Contact information and about who is driving this marketplace.</li>
</ul>',),
  );
}