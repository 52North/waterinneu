	...
	return array (
		...
		'text' => array ('en' => '
				<div id="landing-page-action-buttons" class="container-fluid">
 					<a class="col-lg-4 col-sm-6 col-xs-12" href="products-and-services">
					...
					<a class="col-lg-4 col-sm-6 col-xs-12" href="#about">
						<div id="intro" class="landing-page-button alert alert-info">
				...
				<a class="col-lg-4 col-sm-6 col-xs-12" href="search/advanced">
					...
					<a class="col-lg-4 col-sm-6 col-xs-12" href="e-learning">
					...
					<a class="col-lg-4 col-sm-6 col-xs-12" href="join-us">
				...
				>
				  ...
				  <a class="col-lg-4 col-sm-6 col-xs-12" href="forum">
						<div id="landing-page-button-forum" class="landing-page-button alert alert-info">
							<div class="icon"><span class="glyphicon glyphicon-comment"></span></div>
							<div class="caption">discus</div>
							<div class="explanation">Participate in the latest debates on river basin management</div>
						</div>
				  </a>
				</div>
				',)
