 ...
 */
function micro_zymphonies_theme_breadcrumb($variables) {
 ...
 */
function micro_zymphonies_theme_preprocess_page(&$vars) {
 ...
 */
function micro_zymphonies_theme_preprocess_node(&$variables) {
  $node = $variables['node'];
